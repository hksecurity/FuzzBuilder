...
AFL_USE_ASAN=1 $CXX $CXXFLAGS_TEST $LDFLAGS_TEST -std=c++11 ares-test-fuzz.o fuzzer_main.o \
    -o ares_parse_reply_fuzzer .libs/libcares.a

$CC $CFLAGS_TEST -I. -c test/ares-test-fuzz-name.c \
    -o ares-test-fuzz-name.o

AFL_USE_ASAN=1 $CXX $CXXFLAGS_TEST $LDFLAGS_TEST -std=c++11 ares-test-fuzz-name.o fuzzer_main.o \
